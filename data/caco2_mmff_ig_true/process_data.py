...
X_train, y_train = load_data_from_df('caco2_train.csv', ff='mmff', ignoreInterfragInteractions=True, one_hot_formal_charge=True, use_data_saving=True)

X_val, y_val = load_data_from_df('caco2_val.csv', ff='mmff', ignoreInterfragInteractions=True, one_hot_formal_charge=True, use_data_saving=True)

X_test, y_test = load_data_from_df('caco2_test.csv', ff='mmff', ignoreInterfragInteractions=True, one_hot_formal_charge=True, use_data_saving=True)
