...
data = pd.read_csv('../../train_caco2/repeat_1_uff_ig_true_h64_N6_N_dense2_slope0.16_batch_size64.predict.csv')
...
# 设置标题
plt.title('Caco-2 Permeability Prediction', fontsize=18)
plt.tick_params(axis='both', labelsize=14)

# 显示图形
plt.savefig('caco2.png')
plt.savefig('caco2.pdf')
