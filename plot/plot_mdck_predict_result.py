...
data = pd.read_csv('../../train_mdck_with_pretrained_caco2/repeat_1_uff_ig_true_h64_N6_N_dense2_slope0.16_batch_size64.predict.csv')
...
# 设置标题
plt.title('MDCK Permeability Prediction', fontsize=18)
plt.tick_params(axis='both', labelsize=14)

# 显示图形
plt.savefig('mdck.png')
plt.savefig('mdck.pdf')
