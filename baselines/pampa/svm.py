...
X_train = torch.load('../../data/pampa_for_baselines/X_train_fg.pt')

y_train = pd.read_csv('../../data/pampa_for_baselines/pampa_train.csv')['y'].values

X_test = torch.load('../../data/pampa_for_baselines/X_test_fg.pt')

y_test = pd.read_csv('../../data/pampa_for_baselines/pampa_test.csv')['y'].values
